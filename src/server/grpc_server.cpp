...
// #include "server/handlers/move_camera.hpp"
// #include "server/handlers/stop_camera.hpp"
//
...
//         new MoveCameraCallData(&service_, cq_.get(), database_, logger_);
//         new StopMoveCallData(&service_, cq_.get(), database_, logger_);
//
//         void* tag;
//         bool ok;
